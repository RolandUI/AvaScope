            ...
            await BridgeHeadlessSmokeTests.DispatchAsync(session, async () =>
            {
                ...
                try
                {
                    ...
                    foreach (var method in new[] { BridgeIpcMethods.Input, BridgeIpcMethods.MutateNode, BridgeIpcMethods.InvokeCustomAction,
                        BridgeIpcMethods.VirtualItem, BridgeIpcMethods.NativePicker, BridgeIpcMethods.EnsureState, BridgeIpcMethods.EditText, BridgeIpcMethods.FillForm, BridgeIpcMethods.TableAction })
                    {
