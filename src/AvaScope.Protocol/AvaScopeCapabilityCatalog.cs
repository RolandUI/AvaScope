...
public static class AvaScopeCapabilityCatalog
{
    ...
    private static IReadOnlyList<AvaScopeToolCapability> CreateTools()
    {
        ...
        [
            ...
            Cli("run-scenario", AvaScopeCapabilityIds.RuntimeScenarioRunner, AvaScopeCapabilityIds.RuntimeWorkflowEvidence, AvaScopeCapabilityIds.RuntimeManagedX11, AvaScopeCapabilityIds.SafetyLocalOnly),
            Mcp("run_scenario", AvaScopeCapabilityIds.RuntimeScenarioRunner, AvaScopeCapabilityIds.RuntimeWorkflowEvidence, AvaScopeCapabilityIds.RuntimeManagedX11, AvaScopeCapabilityIds.SafetyLocalOnly),
