...
public static class RuntimeMutationErrorCodes
{
    ...
    public const string RuntimeMutationSelectionIncomplete = "runtime_mutation_selection_incomplete";
    ...
    public const string RuntimeMutationEvidenceTargetUnavailable = "runtime_mutation_evidence_target_unavailable";
}
