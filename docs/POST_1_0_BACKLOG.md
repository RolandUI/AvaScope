...
| Distribution | macOS release assets, signing, notarization, and native installers | Deferred | v1 ships validated NuGet packages plus win/linux framework-dependent ZIPs; installer/signing policy needs separate validation. | P3 | No |
