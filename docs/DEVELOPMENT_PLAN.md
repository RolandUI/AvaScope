...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues). The user explicitly cancelled #154: no Python/Robot adapters, PlatynUI interoperability or foreign workflow import. #117–#122 implementations are in review. #123 adds target/profile doctor, isolated bounded native display/font/renderer probes, explicit compatibility/dependency/origin errors and CLI/MCP parity. The shared profile/doctor/contract batch passed 22/22; Release solution build passed with zero warnings. Native Windows target doctor passed (`50a745dd2bbc4cb7b775ef9829ee1a7e`); generated onboarding passed all 8 lifecycle plus 4 profile CLI/MCP runs with actual log-secret redaction (`2a5494a84cb34d84beaf0a856784129e`). CI 35734957563 passed Windows and Linux X11 foundation gates; macOS failed connecting from the sanitized MCP fixture. Preserve TMPDIR because Unix NamedPipeStream resolves sockets there; rerun hosted macOS to validate this fix. Platform diagnostic artifacts are retained on failure. Next active slice: #124 managed X11 environments; validation is batched at coherent checkpoints. Product version remains `1.4.2` until the final validated `Release 1.5.0` commit.
