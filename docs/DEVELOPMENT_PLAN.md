...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues); #154 cancelled: no Robot Framework/PlatynUI interoperability, adapters or foreign workflow import. #117–#123 are closed after hosted Windows/Linux/macOS run 35738762089. #124–#126 are in review; combined hosted run 35745338184 passed Windows and is finishing Linux/macOS gates. Active #127 implements separate bridge/window/frame/application readiness, optional reflected host declarations, bounded scoped layout/frame sampling and capture-after-render, shared by CLI/MCP and scenario startup. Release build: 0 warnings/errors. Focused contract/readiness/MCP/lifecycle suite: 90/90. The external-provider CLI/MCP success/failure matrix passed all 12 runs on Headless (f00fbcf2e4a74c69893b5863566af550), Win32 (69ddfd13654c43da86c02dd6e14885c3) and managed X11 (9b4772fd267e4d77b4e130fb083e9416). macOS readiness validation joins the next batched hosted gate. Product version remains `1.4.2` until the final validated `Release 1.5.0` commit.
