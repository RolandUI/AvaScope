...
- `R0.8.0-M4 GitHub Actions Example And Artifact Upload`
- GitHub Issue: https://github.com/RolandUI/AvaScope/issues/23
- GitHub Milestone: `v0.8.0`
- Status: `Review`
- Owner: unassigned
- Started: `2026-06-12`
- Goal: provide a documented and validated GitHub Actions example for agent validation checks.

## Next Action

Commit and push the #23 GitHub Actions example slice, confirm remote CI/Release workflow status, then close issue #23 and start the next `v0.8.0` issue.
