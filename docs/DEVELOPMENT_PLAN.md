...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues); #154 cancelled: no foreign framework interoperability/adapters/import. #117–#126 are closed after hosted Windows/Linux/macOS gates 35738762089 and 35745338184. #127 (61b4752, 90 tests plus 12 platform runs) and #128 (5576e70, 112 focused tests and real CLI/MCP parity) are in review. Combined CI 35751038358 passed 563 tests and failed only the new-tool documentation inventory; 643d643 fixes it, and hosted gate 35752219537 is running. #129 adds bounded session-owned sampled change journals, scoped cursors, expiry/overflow resynchronization, local polling and redaction before retention; 16 focused tests passed, including real CLI-to-MCP cursor continuation, sanitized byte-budget artifacts and explicit coalescing coverage. Broader validation remains batched. Next active slice is #130 for selector audits and stable virtualized-item targeting. Product version stays `1.4.2` until the final validated release commit.
