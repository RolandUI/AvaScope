...
Implement #29 capability/version discovery with unsupported-capability diagnostics, add protocol/Core/CLI/MCP compatibility tests, then run full build and test validation.
