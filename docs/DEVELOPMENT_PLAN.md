...
- Goal: re-resolve actionable semantic selectors safely across runtime tree recreation.

## Next Action

Complete selector-state filtering and generation-safe dispatch validation, prove bounded ambiguity diagnostics and no post-dispatch retry, then run full validation and hosted CI.
