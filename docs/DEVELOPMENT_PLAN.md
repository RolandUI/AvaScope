...
- `2026-09-25`: #190 is the sole active issue. The controlled top-level timeout reproduces the old Stop failure; an initial CLI envelope assertion mistake is separately retained. Existing ownership-checked run recovery now handles failed/interrupted startup and prior failed Stop, preserving original failure and separate cleanup status. All 25 affected launch/scenario/ownership/recovery cases pass (2m16s, clean build), including the three new real CLI/PowerShell cases and mismatched live PID refusal. Actual original native standalone-01 recovery exits 0, cleaned/already_exited, preserving outcome=failed/top_levels; original startup/Stop hashes are unchanged. Fresh native standalone start/cleanup remains pending; bootstrap latency cause stays unknown. #189 is review at cef45b7; #184/#185 and full #174 follow. No release.
