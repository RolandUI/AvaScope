...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues); #154 cancelled: no foreign framework interoperability/adapters/import. #117–#128 are closed after hosted gates 35738762089, 35745338184 and 35752219537 (all Windows/Linux/macOS successful). #129 (88de46e) adds scoped sampled change cursors, and #130 (d04e50b) adds verified selectors and stable virtualized item operations. #131 adds disabled-by-default, host-owned fixtures over allowlisted custom actions, explicit test resources, typed parameters, version pinning, bounded scenario readiness/cleanup and redacted action audit. The full Release suite passed 575 tests; final fixture/audit/real CLI+MCP changes passed 21 focused tests after one unchanged retry of a transient Avalonia HeadlessUnitTestSession.Dispose null reference. Release builds are warning-free. #129–#131 await the next combined hosted gate. Next active slice is #132 for native input/dialog strategies. Product version stays `1.4.2` until the final validated release commit.
