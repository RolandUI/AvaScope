...
Add the representative headless Avalonia sample and a repeatable semantic scenario covering gestures, custom actions, aliases, waits, conditions, verification, redacted failure evidence, and owned cleanup without coordinates, sleeps, or persisted runtime ids.
