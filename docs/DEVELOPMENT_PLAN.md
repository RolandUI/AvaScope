...
- `2026-09-25`: #174 Direct table comparison on clean e3cf363 completes 40 public calls (29 MCP/11 CLI), 26 passing checks and four reviewed images; valid/invalid edits, explicit recovery, privacy, reset/stale and historical replay agree with independent state. No new product defect in this scoped round; client 15468 exits 0 and owned app 360 is reset/terminated. CI 36102961992 on 483fedb fails only macOS fixture readiness (new #193): Windows 856 plus six skips, Linux 33, macOS 856/one failure/five skips. #184/#185 affected Unix checks and all six native labs pass; macOS downstream workflow/package gates are skipped. #191/#192 remain open despite passing hosted cases. Select #193 next, then resume remaining #174 families. No active local QA/test process and no release.
