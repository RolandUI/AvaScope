...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues); #154 cancelled: no foreign framework interoperability/adapters/import. #117–#126 are closed after hosted gates 35738762089 and 35745338184. #127 (61b4752) and #128 (5576e70 plus documentation correction 643d643) await hosted gate 35752219537: Windows succeeded, Linux/macOS packaging is running. #129 (88de46e) adds scoped sampled change cursors with privacy before retention and explicit resync. #130 adds snapshot-verified selector recommendations and bounded virtualized find/reveal/select by stable scalar item keys; 27 focused tests passed, including actual CLI/MCP parity, recycling/reordering, duplicates, stale generations and cancellation. Broader validation remains batched. Next active slice is #131 for opt-in deterministic host fixtures. Product version stays `1.4.2` until the final validated release commit.
