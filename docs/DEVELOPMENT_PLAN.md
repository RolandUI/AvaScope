...
Validate the IPC listener fix on hosted platforms, complete combined CI and refreshed Debug/Release and exact-version packaging/dry-runs, close #153/#155 after their evidence passes, then publish and verify Release 1.5.0. #154 remains cancelled; no foreign-framework interoperability is in scope.
