...
- `2026-09-22`: Active release `v1.5.0` / #156 covers #117–#153 and #155 (38 issues); #154 cancelled by user: no foreign framework interoperability/adapters/import. #117–#123 are closed after hosted run 35738762089 passed Windows/Linux/native macOS. #124 (65e154b) and #126 (615093e) are implemented/in review, with native WSL X11 scenarios and 127 bridge/protocol/evidence tests passing. Active #125 adds the same external-provider CLI/MCP lifecycle/modal/focus/popup/resize/DPI scenarios to packaged Headless, Win32, managed X11 and macOS gates, retaining redacted success/failure evidence. The matrix exposed typed timestamps being replaced by non-date exclusion markers; the fix and focused evidence/provenance tests passed 25/25. Local matrix validation passed all 12 runs (CLI/MCP success plus deliberate failure on Headless, Win32 and managed X11): headless-6e5fec7bf56d40bb8ecc44c47b553868, win32-b28bdbdcf0284312986765042b861e59, x11-462401443366485b8dcd1f0c8f0b32ba. The combined hosted gate, including packaged binaries and macOS, is next. Product version remains `1.4.2` until the final validated `Release 1.5.0` commit.
