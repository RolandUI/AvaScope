...
- `2026-09-24`: #157 is the sole active issue. The opacity/transform DPI defect reproduces on actual Avalonia 12.1.0 and 12.1.3, including bridge screenshots. Six 1.5×/2× IPC screenshot/observe/capture_screen regressions failed before a shared public VisualBrush recording mitigation; three 1× controls passed. Afterward, 82 rendering/capture/observation/readiness/evidence tests pass, including group opacity, clips, independent compositor text regions, repeated navigation and unchanged live frames. The minimum 12.1.0 bridge probe also produces the correct five rows. Fresh native/full validation is next; real macOS 2× acceptance remains outstanding. #169 is completed: all jobs of final CI `36014239916` passed and downloaded artifacts were checked. Product remains 1.5.0; no publication.
