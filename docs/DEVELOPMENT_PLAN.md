...
Commit the validated release-candidate working tree as `Release 0.7.0`, push to `master`, and verify the GitHub Release workflow publishes tag `v0.7.0` and the expected release assets. After publication, close GitHub issue #14 and the `v0.7.0` release tracker.
