...
- `2026-09-25`: #189 is the sole active issue; #188 is in review at pushed 92c5f10. Eleven real-Avalonia cases fail before its seven-line InputHitTest correction; all 59 affected tests pass afterward (1m41s), full build clean, fresh Direct/provider packaging verified. Native legacy-hit-direct-01 and legacy-hit-standalone-02 each pass 22 checks: center/clear CLI+MCP agreement, focus, paired release/gesture, negative/unchanged state, reviewed pixels and reset/owned cleanup. Apps 18512/8472 are terminated; clients 2116/16412 exit 0 after 11 calls each. Standalone-01's top-level startup timeout/failed Stop remains separately retained in #190; successful unchanged startup does not explain it. Next #189 separates CLI process exit, output completion and owned child lifetime without changing the 500ms attach deadline or guessing the original cause. Then #190/#184/#185 and full #174; #186 and earlier reviews await the passing combined gate. No local QA/test process is running; no release.
