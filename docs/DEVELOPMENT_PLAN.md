...
- `R0.8.0-M5 MCP/CLI Agent Review Surface`
- GitHub Issue: https://github.com/RolandUI/AvaScope/issues/24
- GitHub Milestone: `v0.8.0`
- Status: `Review`
- Owner: unassigned
- Started: `2026-06-12`
- Goal: make validation output easy for MCP clients and CLI users to summarize and act on.

## Next Action

Commit and push #24 bounded review-surface metadata, confirm remote CI/Release workflow status, then close issue #24 and start the `v0.8.0` release-candidate issue.
