...
Run the full Release, source/package CLI and MCP, and hosted Windows/Linux/macOS gates for the implemented complex workflow; close #108 only after all lanes pass.
