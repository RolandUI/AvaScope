...
- `2026-09-25`: #188 remains sole active after #186 review at 36cc427. Eleven real-Avalonia cases fail before the seven-line InputHitTest correction; all 59 affected tests pass afterward (1m41s), full build clean, fresh Direct/provider packaging verified. Native legacy-hit-direct-01 passes 22 checks including center/clear CLI+MCP, focus, paired release/gesture, negative/unchanged state, reviewed pixels and owned cleanup. Standalone-01 fails top-level startup near late provider activation; the launcher terminates PID 3168, read-only recovery is empty, then lab Stop fails on its stale session. New #190 retains this distinct failure and unknown bootstrap cause; no app-crash or shared #182/#189 cause is claimed. Client 9272 exits 0 after one read, no live app remains from that run. A fresh unchanged standalone-02 startup is running. #189/#190/#184/#185 and #174 remain queued; no release.
