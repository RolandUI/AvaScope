...
Complete CI 35832938516 (including the failed Linux environment job's recheck), focused hosted verification of the isolated-build correction, and refreshed Debug/Release and exact-version packaging/dry-runs. Close #153/#155 after their evidence passes, then publish and verify Release 1.5.0. #154 remains cancelled; no foreign-framework interoperability is in scope.
