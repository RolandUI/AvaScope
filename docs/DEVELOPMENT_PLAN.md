...
- `R1.0.0-M6 Stable Release Commit And Publication`
- GitHub Issue: https://github.com/RolandUI/AvaScope/issues/39
- GitHub Milestone: `v1.0.0`
- Status: `In Progress`
- Owner: unassigned
- Started: `2026-06-13`
- Goal: validate the `v1.0.0` release candidate locally, commit `Release 1.0.0`, publish through the final Release workflow, and record release metadata before closing the milestone.

## Next Action

Run the #39 local release gate on the `1.0.0` release-candidate working tree, then commit `Release 1.0.0` and push so the final Release workflow can publish tag `v1.0.0` and assets.
