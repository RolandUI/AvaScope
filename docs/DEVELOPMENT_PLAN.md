...
- `2026-09-24`: #169 `5bbaad1` passed native standalone M100–M134 (exact mask pixels through MCP/workflow/CLI, unmasked recovery, desired state/replay, Unicode, appearance, exact IDs, stale recovery, popup, load/reset and owned cleanup) and full Release 792/792 with five explicit native skips. Debug build has zero warnings/errors; Debug tests and updated full CI `36014239916` are running. Baseline full CI `36009001380` passed all jobs, native 5/5 per platform and X11 3840×2160 paired CLI/MCP; downloaded evidence inspected. #158/#159/#162/#163 are completed. #157 and #161's outstanding native 2× acceptance are blocked on Retina access. No version or publication change.
