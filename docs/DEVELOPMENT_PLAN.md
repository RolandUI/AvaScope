...
- `2026-09-25`: #172 is resumed as the sole in-progress issue. The shared QA list now uses public stable record keys while preserving original tab/index/text behavior; its independent journal records the selected key. All 12 fixture/virtual-item Release tests passed (30 s, keyed-fixture-results/keyed-fixture.trx), including offscreen lookup/reveal/select, missing/stale/budget refusal, independent table sorting and reset reseeding. Pure standalone QA publish passed. Native Direct/standalone virtual-item and input/focus journeys follow. #179/#181/#182/#183 remain in review, #184/#185 are queued, and #173/#174 remain unfinished. No release.
