...
- `2026-09-24`: #162 is the sole active issue for the observed standalone readiness hook and light-parent popup contrast gaps. #161 is in review at `295939d` after 67 focused and 20 final capture tests; hosted native 4K and true Retina validation remain outstanding. #168 is completed: corrected CI `36006539457` passed all six native host/platform combinations and expiry; downloaded summaries confirm unique open/closed logical popup identities.
