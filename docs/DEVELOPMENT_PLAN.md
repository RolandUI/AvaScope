...
- `2026-09-25`: #184 remains sole active at 8bebfe6. Full before-fix CI 36096369354 is running; Windows Test has passed, Unix reproduction/full gate pending. Native production-bridge ownership-direct-01 passes 24 retained checks through 25 MCP/seven CLI calls: competing acquire/input/cleanup refused, owner input once, explicit handoff/renewal, stale/invalid/expired refusal, reacquire/reset and only-owned/repeated cleanup. Viewed Windows/rendered images and independent journal agree; token-redacted evidence has no known raw lease token. App 19164 is gone, client 6468 exits 0 with empty stderr, Stop confirms already_exited. This Windows/12.1.3/Win32/1x evidence does not prove the Unix fixture cause. Local recovery remains ten pass/one explicit Unix skip; no listener or retry fix yet. Await hosted reproduction; #185/#174 and combined gates remain. No local QA/test process and no release.
